...
var core_1 = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
var chart_component_1 = __webpack_require__("./node_modules/angular2-chartjs/dist/chart.component.js");
...
__export(__webpack_require__("./node_modules/angular2-chartjs/dist/chart.component.js"));
__export(__webpack_require__("./node_modules/angular2-chartjs/dist/chart.module.js"));
...
module.exports = "<!-- <div class=\"row\">\r\n    <div class=\"col-lg-3\">\r\n    <nb-card>\r\n      <nb-card-header>\r\n        Switch\r\n      </nb-card-header>\r\n    </nb-card>\r\n    </div>\r\n \r\n</div> -->\r\n\r\n<div class=\"row\">\r\n  \r\n  <div class=\"col-lg-3\">\r\n      <nb-card>\r\n          <div>\r\n\r\n              <nb-tabset (changeTab)=\"onChangeTab($event)\">\r\n  \r\n                  <nb-tab  [tabTitle]=\"Asia\" [active]=\"aactive\">\r\n                    </nb-tab>\r\n                    <nb-tab  [tabTitle]=\"Paris\" [active]=\"pactive\">\r\n                      </nb-tab>\r\n                </nb-tabset>\r\n           \r\n          </div>\r\n          </nb-card>\r\n    <monthly-trends></monthly-trends>\r\n  </div>\r\n\r\n      <div class=\"col-lg-9\">\r\n        <nb-card>\r\n          <nb-card-header>{{'ERRORS_BY_CATEGORY' | translate}}</nb-card-header>\r\n          <nb-card-body>\r\n          <ngx-chartjs-multiple-xaxis></ngx-chartjs-multiple-xaxis>\r\n          </nb-card-body>\r\n        </nb-card>\r\n      </div>\r\n  \r\n</div>\r\n"
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(translate, router) {
        ...
        // if(localStorage.getItem('region')=='Paris')
        //   this.pactive=true;
        //  else
        //   this.aactive=true;
    }
    ...
    DashboardComponent.prototype.onChangeTab = function (event) {
        //   if(localStorage.getItem('region')=='Paris')
        //   this.active=false;
        //  else
        //   this.active=true;
        ...
        if (!this.isFirstLoad) {
            localStorage.setItem('region', event.tabTitle);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__monthly_trends_monthly_trends_component__ = __webpack_require__("./src/app/pages/dashboard/monthly-trends/monthly-trends.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__line_chart__ = __webpack_require__("./src/app/pages/dashboard/line-chart.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_angular2_chartjs__ = __webpack_require__("./node_modules/angular2-chartjs/dist/index.js");
    ...
    DashboardModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__ngx_translate_core__["b" /* TranslateModule */].forRoot({ loader: {
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_4__monthly_trends_monthly_trends_component__["a" /* MonthlyTrendsComponent */],
                __WEBPACK_IMPORTED_MODULE_5__line_chart__["a" /* ChartjsMultipleXaxisComponent */]
            ],
        })
    ], DashboardModule);
...
/***/ "./src/app/pages/dashboard/line-chart.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_data_services_dashboard_service__ = __webpack_require__("./src/app/@core/data/services/dashboard.service.ts");
...
var ChartjsMultipleXaxisComponent = /** @class */ (function () {
    function ChartjsMultipleXaxisComponent(theme, eService, translate) {
        var _this = this;
        this.theme = theme;
        ...
        this.count = 0;
        this.maxValue = 0;
        this.defaultColors = ['#396AB1', '#DA7C30', '#3E9651', '#CC2529', '#535154', '#6B4C9A', '#922428', '#948B3D'];
        translate.addLangs(["en", "fr"]);
        translate.setDefaultLang('en');
        var browserLang = translate.getBrowserLang();
        translate.use(browserLang.match(/en|fr/) ? browserLang : 'en');
        this.themeSubscription = this.theme.getJsTheme().subscribe(function (config) {
            ...
            _this.eService.getErrorByCategory().subscribe(function (x) {
                if (localStorage.getItem('lang') === "en")
                    _this.label = x.english;
                else
                    _this.label = x.french;
                var _loop_1 = function (num) {
                    translate.get(_this.BuildTranslationKey(num.label)).subscribe(function (res) {
                        _this.qualitychecklabel = res;
                        if (_this.maxValue < num.count)
                            _this.maxValue = num.count;
                        _this.temp = {
                            label: _this.qualitychecklabel,
                            data: num.count,
                            borderColor: _this.defaultColors[_this.count],
                            backgroundColor: _this.defaultColors[_this.count],
                            fill: false,
                            pointRadius: 5,
                            pointHoverRadius: 7,
                        };
                        _this.tempList.push(_this.temp);
                        _this.count++;
                    });
                };
                for (var _i = 0, _a = x.datasetErrorByCategory; _i < _a.length; _i++) {
                    var num = _a[_i];
                    _loop_1(num);
                }
                translate.get('MONTH').subscribe(function (res) {
                    _this.xaxisLabel = res;
                    translate.get('COUNT').subscribe(function (res) {
    ...
    ChartjsMultipleXaxisComponent.prototype.BuildTranslationKey = function (value) {
    ...
    ChartjsMultipleXaxisComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__nebular_theme__["q" /* NbThemeService */],
            __WEBPACK_IMPORTED_MODULE_2__core_data_services_dashboard_service__["a" /* DashboardService */],
...
/***/ "./src/app/pages/dashboard/monthly-trends/monthly-trends.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MonthlyTrendsComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__nebular_theme__ = __webpack_require__("./node_modules/@nebular/theme/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_data_services_dashboard_service__ = __webpack_require__("./src/app/@core/data/services/dashboard.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__("./node_modules/@ngx-translate/core/@ngx-translate/core.es5.js");
...
var MonthlyTrendsComponent = /** @class */ (function () {
    function MonthlyTrendsComponent(eService, themeService, translate) {
        var _this = this;
        this.eService = eService;
        ...
        this.eService.getMonthlyTrends().subscribe(function (x) { console.log(x); _this.data = x; });
        this.themeSubscription = this.themeService.getJsTheme().subscribe(function (theme) {
            _this.currentTheme = theme.name;
        });
    }
    MonthlyTrendsComponent.prototype.ngOnDestroy = function () {
        this.themeSubscription.unsubscribe();
    };
    MonthlyTrendsComponent.prototype.ngOnInit = function () {
    };
    MonthlyTrendsComponent.prototype.onChangeTab = function (event) {
        alert('onchange');
    };
    MonthlyTrendsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'monthly-trends',
            styles: [__webpack_require__("./src/app/pages/dashboard/monthly-trends/monthly-trends.component.scss")],
            template: __webpack_require__("./src/app/pages/dashboard/monthly-trends/monthly-trends.component.html"),
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__core_data_services_dashboard_service__["a" /* DashboardService */], __WEBPACK_IMPORTED_MODULE_1__nebular_theme__["q" /* NbThemeService */],
            __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__["c" /* TranslateService */]])
...
var MENU_ITEMS = [
    ...
    {
        title: 'Create Control Reports',
        link: '/pages/editors/control-report-create',
        icon: 'nb-compose',
        key: 'createreport',
    },
    {
        title: 'Download Control Reports',
        link: '/pages/editors/control-report-download',
        icon: 'nb-tables',
        key: 'downloadreport'
    },
];
...
var PagesComponent = /** @class */ (function () {
    function PagesComponent(translate) {
        this.translate = translate;
        this.menu = [];
    }
    ...
    PagesComponent.prototype.translateMenu = function () {
        var _this = this;
        this.menu.forEach(function (menuItem) {
            _this.translateMenuTitle(menuItem);
        });
    };
    /**
     ...
     * @param prefix
     */
    PagesComponent.prototype.translateMenuTitle = function (menuItem, prefix) {
        var _this = this;
        if (prefix === void 0) { prefix = 'menu'; }
        var key = '';
        try {
            key = (prefix !== '')
                ? PagesComponent_1.getMenuItemKey(menuItem, prefix)
                : PagesComponent_1.getMenuItemKey(menuItem);
        }
        catch (e) {
            //Key not found, don't change the menu item
            return;
        }
        this.translate.get(key).subscribe(function (translation) {
        ...
        if (menuItem.children != null) {
            ...
            menuItem.children.forEach(function (childMenuItem) {
                ...
                _this.translateMenuTitle(childMenuItem, PagesComponent_1.trimLastSelector(key));
            });
        }
    };
    /**
     ...
     * @returns {string}
     */
    PagesComponent.getMenuItemKey = function (menuItem, prefix) {
        if (prefix === void 0) { prefix = 'menu'; }
        if (menuItem.key == null) {
            throw new Error('Key not found');
        }
        var key = menuItem.key.toLowerCase();
        if (menuItem.children != null) {
     ...
     * @returns {string}
     */
    PagesComponent.trimLastSelector = function (key) {
