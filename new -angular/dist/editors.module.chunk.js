...
var ControlReportDownloadComponent = /** @class */ (function () {
    ...
    ControlReportDownloadComponent.prototype.onDownload = function () {
        ...
        this.controlService.FetchControlReports(search)
            ...
            alasql('SELECT transactionReferenceNo as TransactionReferenceNo , createdDate as PSCreateDate,    entity as Entity,  operator as Operator, qualityCheck as PassFail,  qualityCheckFailCategory as ErrorCategory, region as Region, comments as Comments, audit as Audit    INTO XLSX("' + fileName + '.xlsx",{headers:true}) FROM ?', [_this.targetData]);
        });
    };
