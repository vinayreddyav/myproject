...
module.exports = "\r\n\r\n<div class=\"row\">\r\n  \r\n  <div class=\"col-lg-12\">\r\n      <nb-card fullwidth>\r\n          <div>\r\n                <table class=\"table\">\r\n                <thead>\r\n                        <tr>\r\n                            <th rowspan=\"2\" style=\"padding-bottom: 5%\">Country</th>\r\n                            <th colspan=\"2\" style=\"border-right: solid 1px #ffffff\">Priority</th>\r\n                            \r\n                            <th colspan=\"2\" style=\"padding-left: 50px;\">Non-Priority</th>\r\n                            <th rowspan=\"2\" style=\"padding-bottom: 5%\">Total</th>\r\n                        </tr>\r\n                        <tr>\r\n                            <th>>=1</th>\r\n                            <th style=\"border-right: solid 1px #ffffff\">>=2</th>\r\n                            <th style=\"padding-left: 50px;\">>=1</th>\r\n                            <th>>=2</th>\r\n                        </tr>\r\n                        <tr>\r\n                               \r\n                            </tr>\r\n                    </thead>\r\n                    <tbody>\r\n                        <tr *ngFor=\"let item of dashboarddata\">\r\n                            <td style=\" cursor: pointer;\" (click)=\"fnShowDetails(item.country,'')\">{{item.country}}</td>\r\n                            <td style=\"color:red; cursor: pointer;\" (click)=\"fnShowDetails(item.country,'priority.high')\">{{item.priorityCount.high}}</td>\r\n                            <td  style=\"color:#FFCC00; cursor: pointer;\" (click)=\"fnShowDetails(item.country,'priority.standard')\">{{item.priorityCount.standard}}</td>\r\n                            <td style=\"color: #FFCC00; cursor: pointer; padding-left: 50px;\" (click)=\"fnShowDetails(item.country,'nonpriority.high')\">{{item.nonPriorityCount.high}}</td>\r\n                            <td style=\"color:red;cursor: pointer;\" (click)=\"fnShowDetails(item.country,'nonpriority.standard')\">{{item.nonPriorityCount.standard}}</td>\r\n                            <td>\r\n                                    {{item.priorityCount.high + item.priorityCount.standard +\r\n                                    item.nonPriorityCount.high + item.nonPriorityCount.standard}}\r\n                            </td>\r\n                            \r\n                        </tr>\r\n                    </tbody>\r\n                      </table>\r\n          </div>\r\n          </nb-card>\r\n    \r\n  </div>\r\n  <div class=\"col-lg-6\">\r\n  </div>\r\n<div *ngIf=\"!hideDetails\">\r\n  <nb-card>\r\n    <nb-card-header>\r\n      Details\r\n    </nb-card-header>\r\n    <nb-card-body>\r\n      <ng2-smart-table [settings]=\"settings\" [source]=\"source\" >\r\n      </ng2-smart-table>\r\n    </nb-card-body>\r\n  </nb-card>\r\n</div>\r\n      \r\n  \r\n</div>\r\n"
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(eService) {
        var _this = this;
        ...
        this.source = [];
        this.eService.fetchDashboardTableData().subscribe(function (x) {
            _this.dashboarddata = x;
            console.log(_this.dashboarddata);
            //this.source=x[0].priorityTran.high;
        });
    }
    DashboardComponent.prototype.ngOnInit = function () {
    };
    DashboardComponent.prototype.getDateFormat = function (datetime) {
        if (datetime != "") {
    ...
    DashboardComponent.prototype.fnShowDetails = function (country, aging) {
        var _this = this;
        this.hideDetails = false;
        this.eService.fetchDashboardTableData().subscribe(function (x) {
            _this.dashboarddata = x;
            //Date format
            _this.dashboarddata.forEach(function (x) {
                if (x.priorityTran.high.length > 0)
                    x.priorityTran.high.forEach(function (y) { if (y != undefined)
                        y.date = _this.getDateFormat(y.date); });
                if (x.priorityTran.standard.length > 0)
                    x.priorityTran.standard.forEach(function (y) { if (y != undefined)
                        y.date = _this.getDateFormat(y.date); });
                if (x.nonPriorityTran.high.length > 0)
                    x.nonPriorityTran.high.forEach(function (y) { if (y != undefined)
                        y.date = _this.getDateFormat(y.date); });
                if (x.nonPriorityTran.standard.length > 0)
                    x.nonPriorityTran.standard.forEach(function (y) { if (y != undefined)
                        y.date = _this.getDateFormat(y.date); });
            });
            var countryData = _this.dashboarddata.filter(function (c) { return c.country == country; });
            var data = [];
            switch (aging) {
                case "priority.high":
                    _this.source = countryData[0].priorityTran.high;
                    break;
                case "priority.standard":
                    _this.source = countryData[0].priorityTran.standard;
                    break;
                case "nonpriority.high":
                    _this.source = countryData[0].nonPriorityTran.high;
                    break;
                case "nonpriority.standard":
                    _this.source = countryData[0].nonPriorityTran.standard;
                    break;
                default:
                    countryData[0].priorityTran.high.forEach(function (x) { return data.push(x); });
                    countryData[0].priorityTran.standard.forEach(function (x) { return data.push(x); });
                    countryData[0].nonPriorityTran.high.forEach(function (x) { return data.push(x); });
                    countryData[0].nonPriorityTran.standard.forEach(function (x) { return data.push(x); });
                    _this.source = data;
                    break;
            }
        });
    ...
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__core_data_services_dashboard_service__["a" /* DashboardService */]])
    ], DashboardComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_angular2_chartjs__ = __webpack_require__("./node_modules/angular2-chartjs/dist/index.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ngx_slideshow__ = __webpack_require__("./node_modules/ngx-slideshow/ngx-slideshow.es5.js");
    ...
    DashboardModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_6_ngx_slideshow__["a" /* NgxSlideshowModule */].forRoot(),
            ],
            declarations: [
