...
var socialLinks = [];
var NB_CORE_PROVIDERS = __WEBPACK_IMPORTED_MODULE_6__data_data_module__["a" /* DataModule */].forRoot().providers.concat(__WEBPACK_IMPORTED_MODULE_2__theme_components_auth__["d" /* NbAuthModule */].forRoot({
    providers: {
        email: {
            service: __WEBPACK_IMPORTED_MODULE_2__theme_components_auth__["f" /* NbEmailPassAuthProvider */],
            config: {
                delay: 3000,
                login: {
                    rememberMe: true,
...
var CoreModule = /** @class */ (function () {
    ...
    CoreModule = CoreModule_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__theme_components_auth__["d" /* NbAuthModule */],
            ],
            declarations: [],
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__theme_components_auth__ = __webpack_require__("./src/app/@theme/components/auth/index.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardService = /** @class */ (function () {
    function DashboardService(http, authService) {
        ...
        this.token = {};
        this.data = [];
        this.authService.getToken().subscribe(function (x) {
            _this.token = x.getValue();
            _this.httpOptions = {
                headers: new __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json', 'Authorization': "bearer " + _this.token })
            };
        });
    }
    DashboardService.prototype.fetchDashboardTableData = function () {
        var _this = this;
        //return this.http.get<any>(`${environment.baseUrl}EvidenceCount`)
        return this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].baseUrl + "GetDashboardTableData", this.httpOptions).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["b" /* tap */])(function (_) { return _this.log("fetched dashboard table"); }), Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["a" /* catchError */])(this.handleError("dashboard table Error")));
    };
    DashboardService.prototype.fetchDashboardLiveData = function () {
        var _this = this;
        //return this.http.get<any>(`${environment.baseUrl}EvidenceCount`)
        return this.http.get(__WEBPACK_IMPORTED_MODULE_4__environments_environment__["a" /* environment */].baseUrl + "GetDashboardLiveData", this.httpOptions).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["b" /* tap */])(function (_) { return _this.log("fetched dashboard live"); }), Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["a" /* catchError */])(this.handleError("dashboard live Error")));
    };
    /**
    ...
    DashboardService = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_5__theme_components_auth__["e" /* NbAuthService */]])
    ], DashboardService);
    ...
    NbAuthModule.forRoot = function (nbAuthOptions) {
        return {
            ...
            providers: [
                ...
                { provide: __WEBPACK_IMPORTED_MODULE_12__auth_options__["d" /* NB_AUTH_TOKEN_CLASS */], useValue: __WEBPACK_IMPORTED_MODULE_10__services_token_token__["b" /* NbAuthSimpleToken */] },
...
var httpOptions = {
    headers: new __WEBPACK_IMPORTED_MODULE_5__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' })
};
var NbDummyAuthProvider = /** @class */ (function (_super) {
    __extends(NbDummyAuthProvider, _super);
    function NbDummyAuthProvider(http) {
    ...
    NbDummyAuthProvider.prototype.createDummyResult = function (data) {
        ...
        console.log('auth');
        console.log(data);
        //   this.http.post<any>(`${environment.tokenUrl}`,data, httpOptions)
        //   .pipe(
        //     tap((test: any) => this.log(`Calling token service`)),
        //     catchError(this.handleError<any>('ControlReport'))
        //   ).subscribe(x=>{
        //     console.log(x);
        //   return new NbAuthResult(true,this.createSuccessResponse(), 'pages', '',['Successfully logged in.'],x);
        //   }
        // );    
        return new __WEBPACK_IMPORTED_MODULE_4__services_auth_result__["a" /* NbAuthResult */](true, this.createSuccessResponse(), 'pages', ['Successfully logged in.']);
    };
    /**
     * Handle Http operation that failed.
     * Let the app continue.
     ...
     * @param result - optional value to return as the observable result
     */
    NbDummyAuthProvider.prototype.handleError = function (operation, result) {
        var _this = this;
        if (operation === void 0) { operation = 'operation'; }
        return function (error) {
            // TODO: send the error to remote logging infrastructure
    ...
    /** Log a HeroService message with the MessageService */
    NbDummyAuthProvider.prototype.log = function (message) {
        console.log(message);
    };
...
var NbEmailPassAuthProvider = /** @class */ (function (_super) {
    ...
    function NbEmailPassAuthProvider(http, route) {
        ...
        _this.route = route;
        _this.defaultConfig = {
            baseEndpoint: "" + __WEBPACK_IMPORTED_MODULE_10__environments_environment__["a" /* environment */].tokenUrl,
            login: {
                alwaysFail: false,
                rememberMe: true,
                endpoint: '',
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_4__token_token__["a"]; });
...
var NbTokenLocalStorage = /** @class */ (function () {
    ...
    NbTokenLocalStorage.prototype.get = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_2__token__["c" /* nbCreateToken */])(this.tokenClass, localStorage.getItem(this.key));
    };
    /**
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["c"] = nbCreateToken;
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(_route, translate, sidebarService, menuService, userService, analyticsService, router, searchService) {
        ...
        this.userMenu = [{ title: 'Log out', link: '/' }];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_auth__ = __webpack_require__("./src/app/@theme/components/auth/index.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ThemeModule = /** @class */ (function () {
    ...
    ThemeModule.forRoot = function () {
        return {
            ...
            providers: NB_THEME_PROVIDERS.concat([{ provide: __WEBPACK_IMPORTED_MODULE_16__components_auth__["a" /* NB_AUTH_TOKEN_CLASS */], useValue: __WEBPACK_IMPORTED_MODULE_16__components_auth__["c" /* NbAuthJWTToken */] },
                __WEBPACK_IMPORTED_MODULE_4__components_auth_auth_module__["a" /* NbAuthModule */].forRoot({ providers: { email: { service: __WEBPACK_IMPORTED_MODULE_5__components_auth_providers_email_pass_auth_provider__["a" /* NbEmailPassAuthProvider */], config: {}, } } }).providers,]),
        };
    };
...
var routes = [
    ...
    {
        path: 'auth',
        component: __WEBPACK_IMPORTED_MODULE_2__theme_components_auth__["b" /* NbAuthComponent */],
        children: [
            {
                path: '',
                component: __WEBPACK_IMPORTED_MODULE_2__theme_components_auth__["g" /* NbLoginComponent */],
            },
            {
                path: 'login',
                component: __WEBPACK_IMPORTED_MODULE_2__theme_components_auth__["g" /* NbLoginComponent */],
            ...
            {
                path: 'register',
                component: __WEBPACK_IMPORTED_MODULE_2__theme_components_auth__["i" /* NbRegisterComponent */],
            },
            {
                path: 'logout',
                component: __WEBPACK_IMPORTED_MODULE_2__theme_components_auth__["h" /* NbLogoutComponent */],
            },
            {
                path: 'request-password',
                component: __WEBPACK_IMPORTED_MODULE_2__theme_components_auth__["j" /* NbRequestPasswordComponent */],
            },
            {
                path: 'reset-password',
                component: __WEBPACK_IMPORTED_MODULE_2__theme_components_auth__["k" /* NbResetPasswordComponent */],
            },
        ],
    },
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_ngx_slideshow__ = __webpack_require__("./node_modules/ngx-slideshow/ngx-slideshow.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__theme_components_auth__ = __webpack_require__("./src/app/@theme/components/auth/index.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_17_ngx_slideshow__["a" /* NgxSlideshowModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_13_angular_modal_gallery__["a" /* ModalGalleryModule */].forRoot(),
            ...
            providers: [
                ...
                { provide: __WEBPACK_IMPORTED_MODULE_18__theme_components_auth__["a" /* NB_AUTH_TOKEN_CLASS */], useValue: __WEBPACK_IMPORTED_MODULE_18__theme_components_auth__["c" /* NbAuthJWTToken */] },
            ],
        })
    ], AppModule);
    return AppModule;
...
var AuthGuard = /** @class */ (function () {
    ...
    AuthGuard = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__theme_components_auth__["e" /* NbAuthService */], __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]])
    ], AuthGuard);
    return AuthGuard;
}());
...
var environment = {
    production: false,
    baseUrl: 'http://localhost:58841/api/Tralive/',
    tokenUrl: 'http://localhost:58841/api/User/',
};
